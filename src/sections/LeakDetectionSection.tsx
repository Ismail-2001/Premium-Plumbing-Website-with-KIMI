...
export default function LeakDetectionSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="services"
      className="relative w-full h-screen bg-navy overflow-hidden z-[103]"
    >
      ...
      >
        ...
        <span className="text-micro text-gold block mb-4">Leaks & Pipes</span>
        ...
        <p className="text-elite-gray text-[clamp(13px,1.1vw,16px)] leading-relaxed mb-8">
          We find the source fast—behind walls, under floors, or underground—and fix it 
          with minimal disruption. Our advanced detection technology pinpoints leaks 
