...
export default function MaintenanceSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-screen bg-navy overflow-hidden z-[106]"
    >
      ...
      >
        <img
          src="/drain_maintenance_bg.jpg"
          alt="Drain maintenance service"
      ...
      >
        ...
        <span className="text-micro text-gold block mb-4">Maintenance</span>
        ...
        <p className="text-elite-gray text-[clamp(13px,1.1vw,16px)] leading-relaxed mb-8">
          Routine cleaning, camera inspections, and proactive repairs to prevent 
          costly surprises. Our maintenance plans keep your plumbing system running 
          smoothly year-round.
        </p>
